...
# Includes
INCLUDES  += -I. -I$(CUDA_INSTALL_PATH)/include -I$(COMMONDIR)/inc -arch sm_12
ifneq ($(DARWIN),)
...
# Libs
LIB       := -L$(CUDA_INSTALL_PATH)/lib -L$(LIBDIR) -L$(COMMONDIR)/lib -lcuda -lcudart obj_parser/list.cpp obj_parser/objLoader.cpp obj_parser/obj_parser.cpp obj_parser/string_extra.cpp ${OPENGLLIB} $(PARAMGLLIB) $(CUDPPLIB) ${LIB} 
